                                ...
                                <div class="card-body">
                                    <form action="{{route('update_password')}}" method="POST" id="change_password_form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-1" id="old_password" type="password" name="old_password" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-1" id="new_password" type="password" name="new_password" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-1" id="confirm_password" type="password" name="confirm_password" />
