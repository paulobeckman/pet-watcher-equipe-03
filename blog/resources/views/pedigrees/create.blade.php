...
<div class="card mt-3">
    ...
    <div class="card-body">
        <form action="{{ route('new_pedigree') }}" method="post">
            @csrf
            <label for="code" class="form-label">Codigo</label>
            <input class="form-control " type="string" name="code" id="code">
            <label for="origin" class="form-label">Origem</label>
            <input class="form-control " type="string" name="origin" id="origin">
            <label for="reason_inactivation" class="form-label">Animal</label>
            <select class="custom-select mr-sm-2" name="id_animal" id="$animal->animal->id">
